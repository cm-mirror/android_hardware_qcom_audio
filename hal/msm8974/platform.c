...
static const char * device_table[SND_DEVICE_MAX] = {
    ...
    /* Xiaomi Mi5 Backends */
    [SND_DEVICE_IN_CAMCORDER_DMIC] = "camcorder-dmic",
    [SND_DEVICE_IN_CAMCORDER_TMIC_FAR_END] = "camcorder-tmic-far",
    [SND_DEVICE_IN_CAMCORDER_TMIC_NEAR_END] = "camcorder-tmic-near",
    [SND_DEVICE_IN_FRONT_MIC] = "front-mic",
    [SND_DEVICE_IN_HANDSET_DMIC_INTERVIEW] = "handset-dmic-interview",
    [SND_DEVICE_IN_HANDSET_DMIC_MUSIC] = "handset-dmic-music",
    [SND_DEVICE_IN_HANDSET_DMIC_VOICE] = "handset-dmic-voice",
    [SND_DEVICE_IN_MAIN_MIC] = "main-mic",
    [SND_DEVICE_IN_TOP_MIC] = "top-mic",
    [SND_DEVICE_IN_VOICE_SPEAKER_TMIC] = "voice-speaker-tmic",
    [SND_DEVICE_IN_VOICE_SPEAKER_TMIC_CONF] = "voice-speaker-tmic",
...
static int acdb_device_table[SND_DEVICE_MAX] = {
    ...
    /* Xiaomi Mi5 ACDB */
    [SND_DEVICE_IN_CAMCORDER_DMIC] = 85,
    [SND_DEVICE_IN_CAMCORDER_TMIC_FAR_END] = 599,
    [SND_DEVICE_IN_CAMCORDER_TMIC_NEAR_END] = 1111,
    [SND_DEVICE_IN_FRONT_MIC] = 11,
    [SND_DEVICE_IN_HANDSET_DMIC_INTERVIEW] = 1045,
    [SND_DEVICE_IN_HANDSET_DMIC_MUSIC] = 21,
    [SND_DEVICE_IN_HANDSET_DMIC_VOICE] = 533,
    [SND_DEVICE_IN_MAIN_MIC] = 4,
    [SND_DEVICE_IN_TOP_MIC] = 11,
    [SND_DEVICE_IN_VOICE_SPEAKER_TMIC] = 295,
    [SND_DEVICE_IN_VOICE_SPEAKER_TMIC_CONF] = 1319,
};
...
static struct name_to_index snd_device_name_index[SND_DEVICE_MAX] = {
    ...
    /* Xiaomi Mi5 Devices */
    {TO_NAME_INDEX(SND_DEVICE_IN_CAMCORDER_DMIC)},
    {TO_NAME_INDEX(SND_DEVICE_IN_CAMCORDER_TMIC_FAR_END)},
    {TO_NAME_INDEX(SND_DEVICE_IN_CAMCORDER_TMIC_NEAR_END)},
    {TO_NAME_INDEX(SND_DEVICE_IN_FRONT_MIC)},
    {TO_NAME_INDEX(SND_DEVICE_IN_HANDSET_DMIC_INTERVIEW)},
    {TO_NAME_INDEX(SND_DEVICE_IN_HANDSET_DMIC_MUSIC)},
    {TO_NAME_INDEX(SND_DEVICE_IN_HANDSET_DMIC_VOICE)},
    {TO_NAME_INDEX(SND_DEVICE_IN_MAIN_MIC)},
    {TO_NAME_INDEX(SND_DEVICE_IN_TOP_MIC)},
    {TO_NAME_INDEX(SND_DEVICE_IN_VOICE_SPEAKER_TMIC)},
    {TO_NAME_INDEX(SND_DEVICE_IN_VOICE_SPEAKER_TMIC_CONF)},
};
